 ...
 * generated in the unisoft.ws.fnsndscaws2.response package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: unisoft.ws.fnsndscaws2.response
     * 
     */
